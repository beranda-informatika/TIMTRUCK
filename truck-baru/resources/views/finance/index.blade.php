                                    ...
                                    <tr>
                                        ...
                                        <td scope="col">
                                            <div id="kode" style="display: none">{{ $key->id }}</div>
                                                ...
                                                <a href="{{ route('payout.forminvoice', $key->shipmentid) }}"
                                                    class="btn btn-sm btn-pink">UJO</a>
                                                    <a href="{{ route('payout.listinvoice', $key->shipmentid) }}"
                                                        class="btn btn-sm btn-success">ListInvoice</a>
                                                        <a href="{{ route('payout.listinvoice', $key->shipmentid) }}"
                                                            class="btn btn-sm btn-success">Bill</a>
