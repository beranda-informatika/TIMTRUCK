...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Approve Shiping</h4>
                <p class="sub-header">
                ...
                <form role="form" class="parsley-examples" action="{{ route('shiping.update',$key->shipmentid ) }}" method="POST">
                    @csrf
                    <input type="hidden" id="statustrans" name="statustrans" class="form-control" value="Shiping">
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-6">
                   ...
                   <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            <label for="example-select" class="form-label">Tgl.Shiping</label>
                        ...
                        <button type="submit" class="btn btn-success waves-effect waves-light me-1">
                            <i class="fa fa-check"></i> Approve Shiping
                        </button>
