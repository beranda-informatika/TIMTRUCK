        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <form role="form" class="parsley-examples" action="{{ route('groupquotation.update', $groupquotation->groupquotationid) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="groupquotationid"
                                            id="groupquotationid" value="{{ $groupquotation->groupquotationid }}" readonly>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select name="kdcustomer" id="kdcustomer" required class="form-control">
                                            <option value="{{ $groupquotation->kdcustomer }}">
                                                {{ $groupquotation->getcustomer->namacustomer }}</option>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="date" name="datecreated" id="datecreated" value="{{ $groupquotation->datecreated }}">

                                    </div>

                                    <div class="mb-3">
                                        <label for="example-text-input" class="form-label">Description</label>
                                            <textarea id="ckeditor-classic" name="description">{{ $groupquotation->description }}</textarea>
