                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form role="form" class="parsley-examples" action="{{ route('customer.store') }}"
                                method="POST">
                                @csrf
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-4 col-form-label">Code Customer<span
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-4 col-form-label">Name Customer<span
                                            class="text-danger">*</span></label>
                                    <div class="col-7">
                                        <input type="text" required parsley-type="text" class="form-control"
