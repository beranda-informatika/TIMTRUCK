    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form role="form" class="parsley-examples" action="{{ route('rute.update',$rute->routeid) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                                            ...
                                            <tr>
                                                ...
                                                <td width="15%">
                                                    <input type="hidden" name="namarate[]"
                                                        id="namarate{{ $i }}" value="{{ $data->getrate->namarate }}"
...
<script>
    ...
    function total() {
        var x = {{ count($rute->getdetailrute) }};
        var total = 0;
        for (i = 0; i < x; i++) {
