        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title">Shipping Input MRC (kg)</h4>
                </div>
                <div class="card-body p-4">

                    <form role="form" class="parsley-examples" action="{{ route('shipment.storeloadkgmrc') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-1">
                                        <label for="example-select" class="form-label">Unit MRC</label>
                                        <input class="form-control" type="text" name="unitmrc" id="unitmrc"
                                            placeholder="unit mrc" required style="text-transform:uppercase" value="{{ $shipment->unitmrc }}" readonly>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" type="text" name="mrc" id="mrc"
                                            placeholder="totalmrc" required  readonly>
