               ...
               >
                ...
                <td style="text-align: right;">
                    <input class="innilai" type="text" name="nominal[]" id="nominal{{ $i }}"
                        value="{{ $data->nominal }}"
                        @if ($data->f_edit == '0') style="text-align: left; width: 150px; background:rgb(239, 237, 237);  text-align:right" require readonly
                        @else

                        style="text-align: right; width: 150px" @endif
                        @if ($data->f_invoice == '1') style="text-align: left; width: 150px; background:rgb(3, 120, 62);  text-align:right" require readonly
                        @else
...
<div style="text-align: right; padding:10px">
    ...
    <a href="{{ route('payout.forminvoice', $shipment->shipmentid) }}"
