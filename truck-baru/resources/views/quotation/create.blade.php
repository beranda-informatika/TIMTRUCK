        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <form role="form" class="parsley-examples" action="{{ route('quotation.store') }}" method="POST">
                        @csrf
                        <div class="row">
                                ...
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="kdcustomer" id="kdcustomer"
                                            value="{{ $groupquotation->kdcustomer }}" readonly>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="origin" id="origin"
                                            placeholder="Origin" required style="text-transform:uppercase;"
                                            value="{{ old('origin') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="destination" id="destination"
                                            placeholder="Destination" required style="text-transform:uppercase"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <button type="button" id="refresh" class="btn btn-sm btn-primary">Open</button>
                                    ...
                                    <div class="mb-3" id="panelminqty">
                                        ...
                                        <input class="form-control" type="text" name="minqty" id="minqty"
                                            placeholder="Min QTY" style="text-align: right" value="{{ old('minqty') }}">
                                        <input class="form-control" type="text" name="vminqty" id="vminqty"
                                            placeholder="Min QTY" style="text-align: right; background:greenyellow"
                                            value="{{ old('vminqty') }}" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label for="example-text-input" class="form-label">MRC</label>
                                        <input class="form-control" type="text" name="mrc" id="mrc"
                                            placeholder="MRC" style="text-align: right" value="{{ old('mrc') }}">
                                        <input class="form-control" type="text" name="vmrc" id="vmrc"
                                            placeholder="MRC" style="text-align: right; background:greenyellow" readonly
                                            value="{{ old('vmrc') }}">
                                    </div>
