        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title">Quotation Input Schema UJO</h4>
                </div>
                <div class="card-body p-4">

                    <form role="form" class="parsley-examples" action="{{ route('quotation.storeujo') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <div class="mb-1">
                                        <label for="example-text-input" class="form-label">Quotation ID</label>
                                        <input class="form-control" type="text" name="id" id="id"
                                            placeholder="Origin" required style="text-transform:uppercase" value="{{ $quotation->id }}" readonly>
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" type="text" name="origin" id="origin"
                                            placeholder="Origin" required style="text-transform:uppercase" value="{{ $quotation->origin }}" readonly>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" type="text" name="destination" id="destination"
                                            placeholder="Destination" required style="text-transform:uppercase" value="{{ $quotation->destination }}" readonly>

                                    </div>
                                    @if (Auth::user()->roles_id == '4' || Auth::user()->roles_id == '1' || Auth::user()->roles_id == '2')
                                    <div class="mb-1">
                                        <label for="example-text-input" class="col-4">MRC:</label>
                                        {{ number_format($quotation->mrc) }}
                                      </div>
                                        @endif
                                      <div class="mb-1">
                                        <label for="example-text-input" class="col-4">SCHEMA UJO :</label>
                                        {{ number_format($quotation->ujo) }}
                                      </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <label for="inputEmail3" class="col-4">Customer<span
                                                ...
                                                {{ $quotation->getcustomer->namacustomer }}

                                    </div>

                                    <div class="mb-3">
                                    @include('quotation.rateujo')
                                    </div>
                                    <div class="mb-1">
