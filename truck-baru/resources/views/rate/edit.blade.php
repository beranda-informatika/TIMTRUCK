                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted font-14">
                                Form Edit Master rate
                            </p>

                            <form role="form" class="parsley-examples" action="{{ route('rate.update', $rate->rateid)}}" method="POST">
                                @method('PUT')
                                @csrf
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-7">
                                        <select name="kdakun" id="kdakun" required class="form-control">
                                            <option value="{{ $rate->kdakun }}" selected>{{ $rate->getakun->namaakun }}</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-7">
                                       <select name="f_pajak" id="f_pajak" required class="form-control">
                                        <option value="{{ $rate->f_pajak }}" selected>{{ $rate->f_pajak }}</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-7">
                                       <select name="f_default" id="f_default" required class="form-control">
                                        <option value="{{ $rate->f_default }}" selected>{{ $rate->f_default }}</option>
