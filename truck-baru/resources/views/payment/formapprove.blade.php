    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form role="form" class="parsley-examples" action="{{ route('payment.update',$key->shipmentid ) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-6">
                   ...
                   <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            <label for="example-select" class="form-label">Tgl.Payment</label>
                            <input type="date" id="tglpayment" name="tglpayment" class="form-control"
                                value="">
