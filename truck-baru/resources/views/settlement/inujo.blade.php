...
@section('content')
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title">Shipping Input Settlement UJO</h4>
                </div>
                <div class="card-body p-4">

                    <form role="form" class="parsley-examples" action="{{ route('settlement.storeujo') }}" method="POST">
                        @csrf
                        <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <textarea class="form-control" type="text" name="description" id="description" placeholder="Description" required
                                            style="text-transform:uppercase" readonly >{{ $shipment->description }}</textarea>

                                    </div>
                                    <div class="mb-1">
                                        <input type="hidden" name="kdcustomer" id="kdcustomer" value="{{ $shipment->kdcustomer }}">
    ...
    <script>
        ...
        $("#refresh").on("click", function() {
            ...
            $.ajax({
                url: "{{ route('shipment.getrouteall') }}",
                type: "GET",
                dataType: 'html',
                data: {
                    id: kdcustomer,
