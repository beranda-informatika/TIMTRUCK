                ...
                <td style="text-align: right;">
                    @if ($data->rateid == '10011')
                        <input class="innilai" type="text" name="nominal[]" id="nominal{{ $i }}"
                            value="{{ $data->nominal }}"
                            style="width: 75px; background:rgb(239, 237, 237);  text-align:right" require readonly>
                    @else
                        @if ($data->f_settle == '1')
                            <input class="innilai" type="text" name="nominal[]" id="nominal{{ $i }}"
                        ...
                        @else
                            <input class="innilai" type="text" name="nominal[]" id="nominal{{ $i }}"
                                value="{{ $data->nominalsettle }}"
                                style="width: 75px;  text-align:right" require >
                        @endif
                    @endif
                </td>
                ...
                <td style="text-align: right;">
                        ...
                        @if ($data->f_settle == '1')
                            <input class="innilai" type="number" name="qty[]" id="qty{{ $i }}"
                                value="{{ $data->qty }}"
                                style="text-align: left;  background:rgb(239, 237, 237);  text-align:right" require
                                readonly>
                        @else
                            <input class="innilai" type="number" name="qty[]" id="qty{{ $i }}"
                                value="{{ $data->qty }}" style="text-align: left;  text-align:right" require>
                        @endif
